...
set CLASSPATH=%APP_HOME%\lib\hw-helloworld-0.1.0.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute helloworld
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLOWORLD_OPTS%  -classpath "%CLASSPATH%" hello.HelloWorld %CMD_LINE_ARGS%
